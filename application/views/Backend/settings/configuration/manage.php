                ...
                <div class="col-md-12">	
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control email required" id="emailAddress" name="emailAddress" placeholder="Email" value="<?php if(isset($configuration_details->emailAddress) && $configuration_details->emailAddress!=''){ echo $configuration_details->emailAddress;}?>" />
							
					 </div>
					 
					  <div class="form-group">
						<label for="whatsUpNo">What's Up # *</label>
						<input type="text" class="form-control required" id="whatsUpNo" name="whatsUpNo" placeholder="What's Up #" value="<?php if(isset($configuration_details->whatsUpNo) && $configuration_details->whatsUpNo!=''){ echo $configuration_details->whatsUpNo;}?>" />
							
					 </div>
					 
					 <div class="form-group">
						<label for="mexPhone">MEX Phone # *</label>
						<input type="text" class="form-control required" id="mexPhone" name="mexPhone" placeholder="Phone #" value="<?php if(isset($configuration_details->mexPhone) && $configuration_details->mexPhone!=''){ echo $configuration_details->mexPhone;}?>" />
							
					 </div>
					 
					 <div class="form-group">
						<label for="usaPhone">USA Phone # *</label>
						<input type="text" class="form-control required" id="usaPhone" name="usaPhone" placeholder="Phone #" value="<?php if(isset($configuration_details->usaPhone) && $configuration_details->usaPhone!=''){ echo $configuration_details->usaPhone;}?>" />
							
					 </div>
					 
					 <div class="form-group" style="display:none;">
						<label for="weather">Weather</label>
						<input type="number" class="form-control" id="weather" name="weather" placeholder="" value="<?php if(isset($configuration_details->weather) && $configuration_details->weather!=''){ echo $configuration_details->weather;}?>" />
							
					 </div>
					 
					  <div class="form-group" style="display:none;">
						<label for="lcalTime">Local Time</label>
						<input type="text" class="form-control" id="lcalTime" name="lcalTime" placeholder="" value="<?php if(isset($configuration_details->lcalTime) && $configuration_details->lcalTime!=''){ echo $configuration_details->lcalTime;}?>" />
							
					 </div>
					 
					 <div class="form-group">
						<label for="footerContent">Footer Content</label>
						<textarea class="form-control" id="footerContent" name="footerContent" rows="5"><?php if(isset($configuration_details->footerContent) && $configuration_details->footerContent!=''){ echo $configuration_details->footerContent;}?></textarea>
          ...
          <div class="box">
              ...
              <div class="box-body">
                <div class="col-md-12">	
					 ...
					 <div class="form-group">
						<label for="sendNotificationOn">Mail Notification Send On *</label>
						<input type="text" class="form-control required" id="sendNotificationOn" name="sendNotificationOn" placeholder="" value="<?php if(isset($configuration_details->sendNotificationOn) && $configuration_details->sendNotificationOn!=''){ echo $configuration_details->sendNotificationOn;}?>"  >
					 </div>
