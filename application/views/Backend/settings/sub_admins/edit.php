        ...
        <div class="col-md-12">
          ...
          <div class="box">
				   ...
				   <div class=" col-md-3">
				   	 ...
				   	 <div class="form-group " >
								<label >Status*</label> <br />
									 <input type="radio" id="guest_status" name="guest_status"  class="required" value="0" <?php if($guest_details->status==0){?> checked="checked" <?php } ?>> Active &nbsp;&nbsp;&nbsp;&nbsp;
									 <input type="radio" id="guest_status" name="guest_status"  class="required"  value="1" <?php if($guest_details->status==1){?> checked="checked" <?php } ?>> In-active
			...
			<div class="form-group" >
				...
				<?php 
					/*if(isset($guest_details->staffing_agency) && $guest_details->staffing_agency!=''){ 
						$staffing_agency_arr=explode(',',$guest_details->staffing_agency);
					}else{
						$staffing_agency_arr=array();
					}*/
					?>
				<?php //$staffing_agency_listing=get_staffing_agency_listing_ch();?>	
				<?php //foreach($staffing_agency_listing as $staffing_agency_data){?>
				<div class="col-md-12" style="margin: 3px;font-weight: 600;"><input class="required" style="margin-right: 3px;" type="checkbox" name="guest_staffing_agency[]" id="guest_staffing_agency[]" value="<?php //echo $staffing_agency_data->id;?>" <?php //if(in_array($staffing_agency_data->id,$staffing_agency_arr)){?> checked="checked" <?php //} ?> /> <?php //echo $staffing_agency_data->name; if(isset($staffing_agency_data->extra_label) && $staffing_agency_data->extra_label!=''){echo ' ('.$staffing_agency_data->extra_label.')';}?>
				</div>
				<?php //} ?>
			</div>
			</div>-->  
		  ...
		  <div class="box-footer">
					...
					?>
						<input type="checkbox" name="category_ids[]" id="category_ids" style="margin-right:3px;" class="required case_category<?php echo $category_data->id;?>" value="<?php echo $category_data->id;?>" <?php if($count_menu>0){?> checked="checked" <?php } ?>  /> <span style="font-weight:600;"><?php echo $category_data->menu_name;?></span>
					...
					?>
							...
							<span style="color:#2C3B41;  font-weight:600;"><input type="checkbox" style="margin-right:3px;" name="subcategory_ids[]" class="required case_subcategory<?php echo $category_data->id;?>" id="subcategory_ids" value="<?php echo $subcategory_data->id;?>"  <?php if($count_submenu>0){?> checked="checked" <?php } ?> />  <?php echo $subcategory_data->submenu_name;?></span>
					...
					?>
								...
								<input type="checkbox" name="subcategory_subcat_ids[]" id="subcategory_subcat_ids" class="case_ssubcat<?php echo $category_data->id;?>" value="<?php echo $submenu_subcat_data->id;?>" <?php if($count_subcat>0){?> checked="checked" <?php } ?> style="margin-right:3px;" /> <?php echo $submenu_subcat_data->subcate_name;?>
								</div>
							<?php } ?>
							<?php } else{ ?>
							
							<input type="checkbox" name="subcategory_ids[]" id="subcategory_ids" style="margin-right:3px;" class="required case_subcategory<?php echo $category_data->id;?>" value="<?php echo $subcategory_data->id;?>" <?php if($count_submenu>0){?> checked="checked" <?php } ?>  />  <?php echo $subcategory_data->submenu_name;?>
							<?php } ?>
							</div>
