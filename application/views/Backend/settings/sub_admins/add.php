...
<section class="content">
      <div class="row">
		...
		<div class="col-md-4">
			...
			<div class="form-group" >
				<label >E-Mail*</label>
				<input type="text" class="form-control email required" id="guest_email" name="guest_email" placeholder="Guest Email" value=""  >
			</div>
		...
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control required" id="guest_password" name="guest_password" placeholder="Guest Password">
			</div>
		...
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				<input type="radio" id="guest_status" name="guest_status"  class="required" value="0"> Active &nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" id="guest_status" name="guest_status"  class="required"  value="1"> In-active
 			</div>
		</div>
		...
		<!--<div class="col-md-12">
			<div class="form-group" >
				...
				<div class="col-md-12" style="margin: 5px;font-weight: 600;"><input class="required" style="margin-right: 5px;" type="checkbox" name="guest_staffing_agency[]" id="guest_staffing_agency[]" value="<?php //echo $staffing_agency_data->id;?>" /> <?php //echo $staffing_agency_data->name; if(isset($staffing_agency_data->extra_label) && $staffing_agency_data->extra_label!=''){echo ' ('.$staffing_agency_data->extra_label.')';}?>
				</div>
				<?php //} ?>
			</div>
			</div>-->
