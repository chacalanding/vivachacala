...
class Settings_mdl extends CI_Model {
	...
	public function update_configuration(){
		...
		$emailAddress = strtolower(trim($this->input->post('emailAddress')));
		$whatsUpNo = $this->input->post('whatsUpNo');
		$mexPhone = trim($this->input->post('mexPhone'));
		$usaPhone = trim($this->input->post('usaPhone'));
 		$weather = $this->input->post('weather');
		$lcalTime = $this->input->post('lcalTime');
		...
		$sendNotificationOn = strtolower(trim($this->input->post('sendNotificationOn')));
		...
		if(isset($_FILES['photo']['name']) && $_FILES['photo']['name']!=''){
			...
			$data=array("sendNotificationOn"=>$sendNotificationOn,"title"=>$txt_title,"emailAddress"=>$emailAddress, "whatsUpNo"=>$whatsUpNo,"mexPhone"=>$mexPhone, "usaPhone"=>$usaPhone, "weather"=>$weather, "lcalTime"=>$lcalTime, "footerContent"=>$footerContent,"smtp_host"=>$smtp_host,"smtp_port"=>$smtp_port,"smtp_username"=>$smtp_username,"smtp_password"=>$smtp_password,"is_smtp"=>$is_smtp,"mail_title"=>$mail_title,"mail_from_email_address"=>$mail_from_email_address,"social_facebook"=>$social_facebook,"social_twitter"=>$social_twitter,"social_google_plus"=>$social_google_plus,"social_pinterest"=>$social_pinterest,"social_linkedin"=>$social_linkedin,"social_youtube"=>$social_youtube,"social_instagram"=>$social_instagram);
