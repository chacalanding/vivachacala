...
return setTr;}
function setThemeCheckDate(pr_title,pr_class,pr_data_utc,pr_input,pr_fm_input){return'<div class="t-dates t-date-'+pr_class+'">'+'<label class="t-date-info-title">'+pr_title+'</label>'+'<span class=""></span>'+
...
if(pr_in!==null){label_title='';$('.t-date-info-title').addClass('d-none');}
if(e==='check-out'){label_title=settings.titleCheckOut;getDay=pr_out;if(pr_in===pr_out){getDay=null;}else if(pr_out!==null){label_title='';$('.t-date-info-title').addClass('d-none');}
Input='t-end'}
